-- intermediate.i_revenue_egi_scd2_nrt definition

-- Drop table

-- DROP TABLE intermediate.i_revenue_egi_scd2_nrt;

--DROP TABLE intermediate.i_revenue_egi_scd2_nrt;
CREATE TABLE IF NOT EXISTS intermediate.i_revenue_egi_scd2_nrt
(
